  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-navy-900/97 p-4 shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-500',
          side === 'right' &&
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-sm text-white opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-accent-teal focus:ring-offset-2 focus:outline-none">
