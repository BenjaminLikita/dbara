  ...
  return (
    <section className="pb-27.5">
      <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
        <div className="relative min-h-107.5 overflow-hidden rounded-lg bg-text-dark">
          <img
          ...
          />
          <div className="absolute top-6 left-6 z-3 flex items-center gap-2.5 rounded-full bg-white/92 py-2.5 pr-5.5 pl-2.5 text-[0.95rem] font-semibold backdrop-blur-sm">
        ...
        <div>
          ...
          <h2 className="my-4.5 text-[2rem] md:text-[2.6rem]">
            Share Your Thoughts{" "}
            <span className="text-faint">With The World</span>
          </h2>
          <p className="mb-7 max-w-120 text-text-muted">
        ...
        <div className="relative overflow-hidden rounded-lg bg-[linear-gradient(150deg,var(--color-navy-700),var(--color-navy-950))] p-10 text-white lg:col-start-2">
          <Dot small className="top-6 right-15" />
          <Dot className="top-15 right-[18%]" />

          <div
            className="mb-5.5 flex gap-1.5 text-accent-yellow"
          ...
          <blockquote className="max-w-140 text-[1.02rem] font-normal text-[#cdd9e4] italic">
